...
impl TtyInode {
    pub fn new(ino: usize, inode_mode: u16, major: u32, minor: u32) -> Arc<Self> {
        ...
        println!("[TtyInode::new] before inode_on_disk");
        let inode_on_disk = Ext4InodeDisk::new_chr(inode_mode, major, minor);
        println!("[TtyInode::new] after inode_on_disk");
        let inner = TTyInodeInner::new(inode_on_disk);
        Arc::new(TtyInode {
            inode_num: ino,
